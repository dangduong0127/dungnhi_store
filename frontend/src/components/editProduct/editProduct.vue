...
const productName = ref(props.data.name || "");
const productCapitalPrice = ref(props.data.price || 0);
const productSellPrice = ref<number>(props.data.price || 0);
const productBarcode = ref(props.data.barcode || "");
const productQuantity = ref(props.data.quantity || 0);
const productUnit = ref(props.data.unit || "");
const productImage = ref(props.data.image || "");
const productDescription = ref(props.data.description || 0);
...
<template>
  <div>
    <form id="editProduct" @submit.prevent="submitProduct">
      <div class="col-left">
      ...
      <button class="btn-editProduct" type="submit">Cập nhật</button>
    </form>
  </div>
</template>
